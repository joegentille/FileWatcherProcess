...
namespace MonitoringTheFileSystemForChanges
{
    public class FileProcessor
    {
        ...
        public void Process()
        {
            ...
            string completedDirecotryPath = Path.Combine(rootDirectoryPath, CompleteDirectoryName);
            Directory.CreateDirectory(completedDirecotryPath);
            Console.WriteLine($"Moving {inProgressFilePath} to {completedDirecotryPath}");
            //File.Move(inProgressFilePath, Path.Combine(completedDirecotryPath, inputFileName));
            ...
            var completedFilePath = Path.Combine(completedDirecotryPath, completedFileName);
